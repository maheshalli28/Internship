...
.stSidebar button {{
    background-color: #00b4d8; /* Blue button color */
    color: white;
    font-weight: bold;
    padding: 12px 25px;
    border-radius: 5px;
...
.stSidebar button:hover {{
    background-color: #48cae4; /* Lighter blue for hover effect */
}}
...
water = st.sidebar.number_input("Water Intake (in L):", min_value=1.0, max_value=4.0)
